...
7+ years' experience using SQL, Power BI, Excel and R to turn customer, service and revenue data into decisions. Background spans FCA-regulated fintech (TigerWit), multi-client consulting (RiTem Consulting), commercial analytics (360 Degrees Markets), and public sector data (DWP via Teleperformance). MSc Management with Business Analytics (Merit, Bournemouth University, 2024).

- [LinkedIn](https://linkedin.com/in/catherineechendu)
- [GitHub](https://github.com/catherine-echendu/workforce-reward-satisfaction-analysis)
- Email: catherineechendu.uk@gmail.com